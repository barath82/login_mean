...
#email address
email="vigneswaran@meemmemory.com"
...
echo ""
echo "6. converting identity certificate to base64 "
openssl base64 -in identity.p12 -out identityp12.txt


echo ""
echo "7. Copying keys and certs to server folder"
...
#cp identityp12.txt ../identity/identityp12.txt
